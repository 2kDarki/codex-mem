...
description: "Configure Codex-mem behavior and language with the Mode System"
---

# Modes & Languages

Codex-mem uses a flexible **Mode System** to adapt its behavior, observation types, and output language. This allows you to switch between different workflows (like coding vs. email investigation) or languages without reinstalling the toolchain.
