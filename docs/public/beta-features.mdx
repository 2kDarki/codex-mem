...
Codex-mem offers a beta channel for users who want to try experimental features before they're released to the stable channel.
...
1. Open the Codex-mem viewer at http://localhost:37777
...
**Your memory data is always preserved.** The database at `~/.Codex-mem/claude-mem.db` is not affected by version switching. All your observations, sessions, and summaries remain intact.
...
- [Configuration](configuration) - Customize other Codex-mem settings
- [Troubleshooting](troubleshooting) - Common issues and solutions
- [Architecture Overview](architecture/overview) - Understand how Codex-mem works
