# How Codex-mem Uses Hooks: A Lifecycle-Driven Architecture
...
Codex-mem is fundamentally a **hook-driven system**. Every piece of functionality happens in response to lifecycle events:
