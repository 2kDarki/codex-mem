...
description: "System components and data flow in Codex-mem"
---
...
Codex-mem operates as a Codex-first memory system with compatibility paths for Claude Code and Cursor. Its current architecture has six core components:
...
- Location: `~/.Codex-mem/claude-mem.db`
