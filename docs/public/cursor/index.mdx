...
Every Cursor session starts fresh - your AI doesn't remember what it worked on yesterday. Codex-mem changes that. Your agent builds cumulative knowledge about your codebase, decisions, and patterns over time.

Cursor is a supported compatibility host for Codex-mem. Codex remains the primary runtime and package surface.
...
<Info>
**No Codex subscription required.** Use Gemini (free tier) or OpenRouter as your AI provider.
</Info>

## How It Works

Codex-mem integrates with Cursor through native hooks:
...
### Path A: Cursor-Only Users (No Codex)

If you're using Cursor without Codex installed:
...
- Detect you do not have Codex installed
...
If you already use Codex alongside Cursor:
