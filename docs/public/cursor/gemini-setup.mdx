...
description: "Use Codex-mem in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up Codex-mem in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
## Step 2: Clone and Build Codex-mem
...
The wizard will:
1. Detect you do not have Codex installed
...
Codex-mem automatically handles rate limiting for free tier usage:
