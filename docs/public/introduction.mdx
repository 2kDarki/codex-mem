---
title: "Introduction"
description: "Persistent memory compression system for Codex"
---

# Codex-mem

**Persistent memory compression system for Codex**

Codex-mem preserves context across sessions by automatically capturing tool usage observations, generating semantic summaries, and making them available to future sessions. This lets Codex maintain continuity about your project even after a session ends or reconnects.

Codex is the primary runtime for Codex-mem. Claude Code and Cursor remain available as compatibility hosts on the same worker, database, and search pipeline.

## Quick Start

Install the CLI and initialize Codex memory for your machine:
...
Start a new Codex session after initialization and context from previous sessions will keep accumulating automatically.

## Key Features

- 🧠 **Persistent Memory** - Context survives across sessions
- 📁 **Folder Context Files** - Auto-generated `AGENTS.md` in project folders with activity timelines
...
<CardGroup cols={2}>
  ...
  <Card title="Folder Context" icon="folder-open" href="/usage/folder-context">
    Auto-generated folder AGENTS.md files
  </Card>
