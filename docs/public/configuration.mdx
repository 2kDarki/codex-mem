---
title: "Configuration"
description: "Environment variables and settings for Codex-mem"
---
...
Codex-mem provides MCP search tools for querying your project history.

**No configuration required** - MCP tools are automatically available in Codex sessions.
...
- **Auto-Invocation**: Codex recognizes natural language queries about past work

## Version Channel

Codex-mem supports switching between stable and beta versions via the web viewer UI.
...
Codex-mem can automatically generate `AGENTS.md` files in your project folders with activity timelines. This feature is disabled by default.

| Setting | Default | Description |
|---------|---------|-------------|
| `CLAUDE_MEM_FOLDER_AGENTSMD_ENABLED` | `false` | Enable auto-generation of folder AGENTS.md files |
...
Codex-mem injects past observations into each new session, giving Codex awareness of recent work. You can configure exactly what gets injected using the **Context Settings Modal**.
...
The Terminal Preview shows exactly what will be injected at the start of your next Codex session for the selected project.
