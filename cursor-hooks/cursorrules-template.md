...
If you want to add custom instructions about codex-mem (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/codex-mem-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using codex-mem memory system"
---

# Memory System Usage

You have access to codex-mem, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/codex-mem-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/codex-mem-instructions.mdc` | MCP tool instructions | You (optional) |
