...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.Codex-mem', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.Codex-mem', 'transcript-watch-state.json');
